...
import 'package:movies_app/features/HomeTab/presentation/cubit/movies_cubit.dart';
import 'package:movies_app/features/HomeTab/presentation/cubit/movies_state.dart';
import 'package:movies_app/features/HomeTab/presentation/widget/CategorySection.dart';
...
class _HometabState extends State<Hometab> {
  ...
  final List<String> genresToDisplay = const ["Action", "Comedy", "Thriller", "Romance"];
          ...
          child: Column(
            children: [
              BlocBuilder<MoviesCubit, MoviesState>(
                buildWhen: (previous, current) => current is MoviesSuccess,
                builder: (context, state) {
                  if (state is MoviesSuccess && state.topMovies.isNotEmpty && _currentMovieImage == null) {
                                    ...
                                    return CarouselSlider(
                                      options: CarouselOptions(
                                        ...
                                        onPageChanged: (index, reason) {
                                          _updateBackgroundImage(topMovies, index);
                                        },
                                      ),
